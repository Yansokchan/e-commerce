    ...
    <div className="px-6 my-20 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 gap-y-10 mt-26">
        {ourSpecsData.map((spec, index) => {
          return (
            <div
              className="relative clay-element h-44 px-8 flex flex-col items-center justify-center w-full text-center rounded-lg group"
              style={{
            ...
            >
              ...
              <div
                className="absolute clay-element -top-5 text-white size-10 flex items-center justify-center rounded-md group-hover:scale-105 transition"
